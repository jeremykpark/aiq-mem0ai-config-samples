...
class Mem0NGCNvidiaMemoryClientConfig(MemoryBaseConfig, name="mem0_ngc_nvidia"):
...
@register_memory(config_type=Mem0NGCNvidiaMemoryClientConfig)
async def mem0_memory_client(config: Mem0NGCNvidiaMemoryClientConfig, builder: Builder):
    import os
